...
var networks = map[string]struct {
	...
	flagNetworkLocalL1Key: {Name: "Local L1", URL: operations.DefaultL1NetworkURL, ChainID: operations.DefaultL1ChainID, ChainType: operations.DefaultL1ChainType, EventURL: operations.DefaultL1EventURL, EventURLApiKey: operations.DefaultL1EventURLApiKey, PrivateKey: operations.DefaultSequencerPrivateKey, networkLayer: networkLayer1},
	flagNetworkLocalL2Key: {Name: "Local L2", URL: operations.DefaultL2NetworkURL, ChainID: operations.DefaultL2ChainID, ChainType: operations.DefaultL2ChainType, EventURL: operations.DefaultL2EventURL, EventURLApiKey: operations.DefaultL2EventURLApiKey, PrivateKey: operations.DefaultSequencerPrivateKey, networkLayer: networkLayer2},
}
