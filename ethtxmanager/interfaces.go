...
type ethermanInterface interface {
	...
	WaitTxToBeMined(ctx context.Context, tx *types.Transaction, txHash string, timeout time.Duration) (bool, error)
	SendTx(ctx context.Context, tx *types.Transaction, tronTx *tronPb.Transaction) error
	...
	SignTx(ctx context.Context, sender common.Address, tx *types.Transaction) (common.Hash, *types.Transaction, *tronPb.Transaction, error)
