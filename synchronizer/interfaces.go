...
type ethermanInterface interface {
	HeaderByNumber(ctx context.Context, number *big.Int) (*types.Header, common.Hash, error)
	...
	EthBlockByNumber(ctx context.Context, blockNumber uint64) (*types.Block, common.Hash, error)
